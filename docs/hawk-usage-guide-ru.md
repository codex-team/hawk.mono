...
На текущий момент Хоук поддерживает вход только по email. После регистрации пароль приходит на указанную почту. В дальнейшем его можно изменить в настройках аккаунта.
...
* **Обычный участник**: может просматривать проекты и события, приглашать новых участников, назначать исполнителей, ставить отметки о исправленных/игнорируемых ошибках.
